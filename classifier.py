...
class CLASSIFIER:
    # train_Y is interger 
    def __init__(self, _train_X, _train_Y, data_loader, _nclass, _cuda, discriminator, _lr=0.001, _beta1=0.5,
    ...
    def fit_zsl(self):
        ...
        for epoch in range(self.nepoch):
            for i in range(0, self.ntrain, self.batch_size):
                ...
                inputv, _ = self.discriminator(inputv.cuda())
            ...
            test_unseen, _ = self.discriminator(self.test_unseen_feature.cuda())
    ...
    def fit(self):
        ...
        for epoch in range(self.nepoch):
            ...
            test_seen, _ = self.discriminator(self.test_seen_feature.cuda())
            test_unseen, _ = self.discriminator(self.test_unseen_feature.cuda())
            # print("-------------------------seen-------------------------------------------")
